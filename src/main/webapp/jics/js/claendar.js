...
//=========================================================================================
			...
			for ( var i = 0; i < nowDaysNub; i++) {
				...
				if (work) {
					if (i == (nowDay - 1)) {
						$dayItem
								.append("<div class=\"onwork item currentItem\" onClick=\"showDetail(this)\"><a>"
										+ (i + 1) + "</a></div>");
					} else {
						$dayItem
								.append("<div class=\"onwork item\" onClick=\"showDetail(this)\"><a>"
										+ (i + 1) + "</a></div>");
					}
				} else {
					if (i == (nowDay - 1)) {
						$dayItem
								.append("<div class=\"item currentItem\" onClick=\"showDetail(this)\"><a>"
										+ (i + 1) + "</a></div>");
					} else {
						$dayItem
								.append("<div class=\"item\" onClick=\"showDetail(this)\"><a>"
										+ (i + 1) + "</a></div>");
					}
				}
			}
